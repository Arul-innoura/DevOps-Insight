...
import { showBrowserNotification } from './pushNotificationService';
...
export const ToastProvider = ({ children }) => {
    ...
    const addToast = useCallback(({
        ...
        // Show native OS notification when the user is in another tab / window.
        if (title) {
            showBrowserNotification(`ShipIt — ${title}`, {
                body: message || '',
                tag: `shipit-toast-${type}`
            });
        }
