...
import DevOpsCycleCostPanel from "./DevOpsCycleCostPanel";
        ...
        <div className={`dashboard-layout devops-dashboard ${isReadOnly ? 'is-readonly' : ''}`}>
                    ...
                    <div className="sb-group">
                        ...
                        {navGroups.team && (
                            <div className="sb-group-items">
                                ...
                                <a href="#" className={`sb-item ${activeSection === 'monitoring' ? 'active' : ''} ${hasLiveEnv ? 'sb-item--monitoring-live' : ''}`}
                                ...
                                <a href="#" className={`sb-item ${activeSection === 'costCycles' ? 'active' : ''}`}
                                   onClick={(e) => { e.preventDefault(); handleSectionChange('costCycles'); }}
                                   title="Live cost & per-cycle history per project (DevOps only)">
                                    <span className="sb-item-icon"><Activity size={15} /></span>
                                    <span className="sb-item-text">Cost Cycles</span>
                                </a>
                                <a href="#" className={`sb-item ${activeSection === 'liveCost' ? 'active' : ''}`}
                                   onClick={(e) => { e.preventDefault(); handleSectionChange('liveCost'); }}
            ...
            <main className="dashboard-content">
                        ...
                        <div className="header-title-section">
                            <div className="breadcrumb">
                                ...
                                <span>
                                    ...
                                    {activeSection === 'costCycles' && 'Cost Cycles'}
                            ...
                            <h1>
                                ...
                                {activeSection === 'costCycles' && 'Cost Cycles — per project run'}
                ...
                {activeSection === 'monitoring' ? (
                    <EnvUptimeDashboard role="devops" />
                ) : activeSection === 'costCycles' ? (
                    <DevOpsCycleCostPanel />
