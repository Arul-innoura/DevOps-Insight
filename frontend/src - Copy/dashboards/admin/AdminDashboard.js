                    ...
                    <div className="sb-group">
                        ...
                        {navGroups.configuration && (
                            <div className="sb-group-items">
                                ...
                                <a href="#" className={`sb-item ${viewMode === 'billing' ? 'active' : ''}`}
                                   onClick={(e) => { e.preventDefault(); setViewMode('billing'); }}>
                                    <span className="sb-item-icon"><DollarSign size={15} /></span>
                                    <span className="sb-item-text">Cloud Bill</span>
                                </a>
                                ...
                                <a href="#" className={`sb-item ${viewMode === 'environments' ? 'active' : ''}`}
                                   onClick={(e) => { e.preventDefault(); setViewMode('environments'); }}
                                   title="Legacy flat environments view (kept for reference)">
                                    <span className="sb-item-icon"><Layers size={15} /></span>
                                    <span className="sb-item-text">Environments (legacy)</span>
                                </a>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="header-top">
                        ...
                        <div className="header-title-section">
                            ...
                            <h1>
                                ...
                                {viewMode === 'cloudServices' && 'Cloud Services'}
                                {viewMode === 'billing' && 'Cloud Bill — Live cost per project'}
                                {viewMode === 'environments' && 'Managed Azure Environments'}
