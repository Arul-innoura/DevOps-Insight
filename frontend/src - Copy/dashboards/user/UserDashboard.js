        ...
        <div className="dashboard-layout user-dashboard">
                    ...
                    <div className="sb-group">
                        ...
                        {navGroups.system && (
                            <div className="sb-group-items">
                                ...
                                <button type="button" className={`sb-item ${activeSection === 'monitoring' ? 'active' : ''} ${hasLiveEnv ? 'sb-item--monitoring-live' : ''}`}
            ...
            <main className="dashboard-content">
                ...
                {activeSection === 'requests' && liveEnvSummary.hasLive && (
                    <div className="ud-live-banner" onClick={() => setActiveSection('monitoring')} role="button" tabIndex={0}
                        onKeyDown={e => e.key === 'Enter' && setActiveSection('monitoring')}>
                        ...
                        <span className="ud-live-cta">View Analytics →</span>
                    </div>
                )}
